            ...
            <pod>
                ...
                <dataset>
                    ...
                    <param>
                        ...
                        <index>0</index>
                        <value>foo@mtn.liquidtelecom.net</value>
                    </param>
                </dataset>
            </pod>
        </sod>
...
""")
    ...
    def test_outgoing_workorders_in_correct_order(self):
        self.assertEquals('LST-ONTDETAIL', self.cart_order_tracing.outgoing_workorders[0].name)
        self.assertEquals('DEL-ONT', self.cart_order_tracing.outgoing_workorders[1].name)
